// Science Component - Lazy Loaded
import React, { useState, useEffect } from 'react';
import { ProgressiveLoader } from '../../utils/lazyLoading';

const ScienceComponent = ({ onQuestionComplete, gameSettings = {} }) => {
  ...
  const loadScienceContent = async () => {
    try {
      ...
      // Dynamically import science content
      const { scienceQuestions, scienceAchievements } = await import('../../data/subjects/scienceContent');
      ...
      setAchievements(scienceAchievements);
      
      // Track loading performance
      if (window.emmyPerformance?.monitor) {
        window.emmyPerformance.monitor.recordCustomMetric('science_content_loaded', performance.now());
      }
      
    } catch (error) {
      console.error('Failed to load science content:', error);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600">
        <div className="text-center text-white">
          ...
          <div className="text-2xl mb-4">Loading Science Adventure...</div>
  ...
  if (questions.length === 0) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600">
        <div className="text-center text-white">
          <div className="text-6xl mb-4">❌</div>
          <div className="text-2xl mb-4">Failed to load Science content</div>
          <button 
            onClick={loadScienceContent}
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Science Adventure</h1>
